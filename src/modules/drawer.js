...
export function createEditDrawer(dataToEdit) {
  const html = `
    <!-- drawer component -->
    <div id="drawer-edit" class="text-center fixed top-0 left-0 right-0 z-40 w-full p-4 transition-transform -translate-y-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-edit-label">
        ...
        <form class="max-w-sm mx-auto">
            ...
            <button type="button" data-drawer-hide="drawer-edit" id="weight-edit-button" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 inline-flex items-center p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled>Submit edit</button>
        </form>
    </div>
  `;
